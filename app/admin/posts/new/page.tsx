...
export default function PostEditorPage({ params }: { params: Promise<{ id?: string[] }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent, publishStatus?: string) => {
    ...
    const payload = {
      ...
      published_at: (publishStatus || form.status) === 'published' ? new Date().toISOString() : null,
      ...
      <form onSubmit={(e) => handleSubmit(e)} className="space-y-6">
        <Card className="border-border/60">
          <CardContent className="pt-6 space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="excerpt">Excerpt (short summary shown on blog listing) *</Label>
              <Textarea
                id="excerpt"
                required
                rows={2}
                ...
                placeholder="Most businesses lose revenue not from a lack of effort, but from small, fixable gaps..."
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="content">Content (use # for headings, ## for subheadings, - for bullet points) *</Label>
              <Textarea
                id="content"
                required
                rows={16}
          ...
          <CardContent className="pt-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="sales, revenue, pipeline"
              />
            </div>
          ...
          <CardContent className="pt-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="5 Sales Mistakes Costing You Revenue | Salesway Consulting"
              />
            </div>
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Five common sales mistakes that quietly drain revenue, and practical fixes for each one."
              />
            </div>
          </CardContent>
        </Card>
        ...
        <div className="flex gap-3">
          <Button type="button" variant="outline" onClick={() => handleSubmit({ preventDefault: () => {} } as React.FormEvent, 'draft')} disabled={saving}>
